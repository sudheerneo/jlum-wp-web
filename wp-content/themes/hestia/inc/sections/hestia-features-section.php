...
if ( ! function_exists( 'hestia_features' ) ) :
	...
	function hestia_features() {
		...
		if ( ( (bool) defined( 'HESTIA_COMPANION_PATH' ) ) || ( (bool) defined( 'HESTIA_PRO_FLAG' ) ) || (bool) defined( 'HESTIA_THEMEISLE_LITE' ) ) {
			$hestia_features_title    = get_theme_mod( 'hestia_features_title', esc_html__( 'Why our product is the best', 'hestia' ) );
			$hestia_features_subtitle = get_theme_mod( 'hestia_features_subtitle', esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'hestia' ) );
