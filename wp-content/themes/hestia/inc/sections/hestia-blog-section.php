...
if ( ! function_exists( 'hestia_blog' ) ) :
	...
	function hestia_blog() {
		...
		$hestia_blog_title = get_theme_mod( 'hestia_blog_title', esc_html__( 'Blog', 'hestia' ) );
		$hestia_blog_subtitle = get_theme_mod( 'hestia_blog_subtitle', esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'hestia' ) );
