...
function hestia_big_title_customize_register( $wp_customize ) {
	...
	if ( empty( $hestia_slider_content ) ) {
		...
		$wp_customize->get_setting( 'hestia_big_title_title' )->default = esc_html__( 'Lorem Ipsum', 'hestia' );
		$wp_customize->get_setting( 'hestia_big_title_text' )->default = esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'hestia' );
		$wp_customize->get_setting( 'hestia_big_title_button_text' )->default = esc_html__( 'Button', 'hestia' );
