...
function hestia_scripts() {
	...
	wp_enqueue_script( 'hestia_scripts', get_template_directory_uri() . '/assets/js/scripts.js', array( 'jquery-hestia-material', 'jquery-ui-core' ),'',true );
	...
	wp_localize_script( 'hestia_scripts', 'viewcart', array(
		'view_cart_label' => esc_html__( 'View cart', 'hestia' ), // label of View cart button,
		'view_cart_link' => $hestia_cart_url, // link of View cart button
	) );
}
