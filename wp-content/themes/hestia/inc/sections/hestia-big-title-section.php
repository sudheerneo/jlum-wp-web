		...
		<div id="carousel-hestia-generic" class="carousel slide" data-ride="carousel">
			<div class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
					...
					$hestia_big_title_title       = get_theme_mod( 'hestia_big_title_title', esc_html__( 'Lorem Ipsum', 'hestia' ) );
					$hestia_big_title_text        = get_theme_mod( 'hestia_big_title_text', esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'hestia' ) );
					$hestia_big_title_button_text = get_theme_mod( 'hestia_big_title_button_text', esc_html__( 'Button', 'hestia' ) );
